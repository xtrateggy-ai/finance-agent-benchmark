...
<<<<<<< HEAD:app/green_agent_mcp_a2a_judge_rag.py
>>>>>>> b2ca3b5 (optimize the tool description to help LLM decide more accurately):app/green_agent_mcp_a2a_judge.py
=======
from tools.yfinance_search import *
from tools.today_date import get_today_date
>>>>>>> 125a25e (a tool to provide todays date for llms with data till specific date):app/green_agent_mcp_a2a_judge.py
